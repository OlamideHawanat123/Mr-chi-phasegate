...
public class MyMenstrualApp {
    ...
    public MyMenstrualApp(String startDate, String endDate, int cycleDays, int periodDuration, int shortestCycle) {
    ...
    public String nextFlowEndingDate() {
        ...
        LocalDate nextFlowEndDate = periodEndTime.plusDays(periodDuration - 1);
